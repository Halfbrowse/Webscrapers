    ...
    def parse(self, response):
        ...
        for product in products:
            yield {
                ...
                'storename': product.xpath(".//button[@class='itemStore bp-p-storeLink bp-c-linkableButton  bp-c-button js-button bp-c-button--link']/text() | //a[@class='itemStore bp-p-storeLink bp-c-link']/text()").get(),
